        ...
        implements Map<K,V>, Cloneable, Serializable
{
    ...
    /**
     * The number of times this HashMap7 has been structurally modified
     * Structural modifications are those that change the number of mappings in
     * the HashMap7 or otherwise modify its internal structure (e.g.,
     * rehash).  This field is used to make iterators on Collection-views of
     * the HashMap7 fail-fast.  (See ConcurrentModificationException).
     */
    transient int modCount;

    /**
     * Constructs an empty <tt>HashMap7</tt> with the specified initial
    ...
    /**
     * Constructs an empty <tt>HashMap7</tt> with the default initial capacity
    ...
    public HashMap7(float loadFactor) {
        this.loadFactor = loadFactor;
    }
     ...
     * because HashMap7 uses power-of-two length hash tables, that
     ...
     * HashMap7.  Returns null if the HashMap7 contains no mapping
     * for the key.
     */
     ...
     * in the HashMap7.  Returns null if the HashMap7 contains no mapping
     * for this key.
     */
     ...
     *
     * Subclass overrides this to alter the behavior of HashMap7(Map),
...
//    }
    ...
    /**
     * Reconstitute the <tt>HashMap7</tt> instance from a stream (i.e.,
     * deserialize it).
     */

 ...
 *
 * For specific details see the {@link } constructors.
 *
 * @since 1.8
 */
enum StreamOpFlag {
    ...
    DISTINCT(0,
            set(StreamOpFlag.Type.SPLITERATOR).set(StreamOpFlag.Type.STREAM).setAndClear(
    ...
    ORDERED(2,
            set(StreamOpFlag.Type.SPLITERATOR).set(StreamOpFlag.Type.STREAM).setAndClear(
                            StreamOpFlag.Type.OP).clear(StreamOpFlag.Type.TERMINAL_OP)
    ...
    SIZED(3,
            set(StreamOpFlag.Type.SPLITERATOR).set(StreamOpFlag.Type.STREAM).clear(
                    StreamOpFlag.Type.OP)),
    ...
    public static void main(String[] args) {
        //set 哪些位是对应set的，
        // DISTINCT中，有一个Map,存储一些标志位，  set = SET_BITS<<0
